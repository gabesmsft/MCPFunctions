...
1. Under **servers** in the mcp.json in VS Code, click Start if the server isn't Running, or click Restart if it shows to be in Error state.
2. 
...
where the search boxWhen prompted for the mcp key, enter the mcp_extension key you obtained earlier.
